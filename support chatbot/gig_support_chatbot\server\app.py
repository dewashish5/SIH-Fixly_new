"""
Standalone Lightweight HTTP Server with CORS and Static File Support.
"""
...
# Ensure package root is in sys.path regardless of execution directory
...
class ChatbotHTTPRequestHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        # Static file handling (demo / widget assets)
...
def create_server(host: str = "127.0.0.1", port: int = 8080, engine: Optional[ChatbotEngine] = None) -> HTTPServer:
    ChatbotHTTPRequestHandler.router = APIRouter(engine or ChatbotEngine())
    server = HTTPServer((host, port), ChatbotHTTPRequestHandler)
    return server
...
def run_server(host: str = "127.0.0.1", port: int = 8080):
    ...
    print("=========================================================")
    print(f"[SERVER RUNNING] Gig Support Chatbot Server")
    print(f"URL: http://{host}:{port}/")
    print(f"Interactive Playground: http://{host}:{port}/demo/index.html")
    print(f"Customer App Demo:      http://{host}:{port}/demo/customer_app_demo.html")
    print(f"Worker App Demo:        http://{host}:{port}/demo/worker_app_demo.html")
    print("=========================================================")

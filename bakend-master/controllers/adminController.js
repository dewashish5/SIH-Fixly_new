...
export const createService = async (req, res) => {
    try {
        ...
        if (!title || !category || !basePrice) {
            return res.status(400).json({ success: false, message: 'Title, category, and basePrice are required' });
        }
        ...
        const newService = new Service({
            ...
            whatsIncluded: Array.isArray(whatsIncluded) ? whatsIncluded : (whatsIncluded ? [whatsIncluded] : []),
